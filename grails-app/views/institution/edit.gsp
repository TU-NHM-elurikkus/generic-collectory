                        ...
                        <tbody>
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="guid">
                                        <g:message code="providerGroup.guid.label" default="Guid" />
                                    </label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="name">
                                        <g:message code="providerGroup.name.label" default="Name" />
                                    </label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="acronym">
                                        <g:message code="providerGroup.acronym.label" default="Acronym" />
                                    </label>
                                </td>
                                ...
                                <tr class="prop">
                                    <td valign="top" class="name">
                                        <label for="isALAPartner">
                                            <g:message code="providerGroup.isALAPartner.label" default="Is ALA Partner" />
                                        </label>
                                    </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="pubDescription">
                                        <g:message code="providerGroup.pubDescription.label" default="Public Description" />
                                    </label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="techDescription">
                                        <g:message code="providerGroup.techDescription.label" default="Technical Description" />
                                    </label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="focus">
                                        <g:message code="providerGroup.focus.label" default="Contribution to ALA" />
                                    </label>
                                </td>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top">
                                    <table class="shy">
                                        <tr class='prop'>
                                            <td valign="top" class="name">
                                                <label for="address.street">
                                                    <g:message code="providerGroup.address.street.label" default="Street" />
                                                </label>
                                            </td>
                                        ...
                                        <tr class='prop'>
                                            <td valign="top" class="name">
                                                <label for="address.postBox">
                                                    <g:message code="providerGroup.address.postBox.label" default="Post box" />
                                                </label>
                                            </td>
                                        ...
                                        <tr class='prop'>
                                            <td valign="top" class="name">
                                                <label for="address.city">
                                                    <g:message code="providerGroup.address.city.label" default="City" />
                                                </label>
                                            </td>
                                        ...
                                        <tr class='prop'>
                                            <td valign="top" class="name">
                                                <label for="address.state">
                                                    <g:message code="providerGroup.address.state.label" default="State or territory" />
                                                </label>
                                            </td>
                                        ...
                                        <tr class='prop'>
                                            <td valign="top" class="name">
                                                <label for="address.postcode">
                                                    <g:message code="providerGroup.address.postcode.label" default="Postcode" />
                                                </label>
                                            </td>
                                        ...
                                        <tr class='prop'>
                                            <td valign="top" class="name">
                                                <label for="address.country">
                                                    <g:message code="providerGroup.address.country.label" default="Country" />
                                                </label>
                                            </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="state">
                                        <g:message code="providerGroup.state.label" default="State" />
                                    </label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="logoRef">
                                        <g:message code="providerGroup.logoRef.label" default="Logo Ref" />
                                    </label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="imageRef">
                                        <g:message code="providerGroup.imageRef.label" default="Image Ref" />
                                    </label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="email">
                                        <g:message code="providerGroup.email.label" default="Email" />
                                    </label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="phone">
                                        <g:message code="providerGroup.phone.label" default="Phone" />
                                    </label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="institutionType">
                                        <g:message code="providerGroup.institutionType.label" default="Institution Type" />
                                    </label>
                                </td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <p class="wizardHeading">
                                        <g:message code="institution.edit.des01" />
                                    </p>

                                    <span style="margin-left:50px;">
                                        <g:message code="providerGroup.existingContacts.label" default="Current contacts for this institution" />
                                    </span>

                                    <table style="width:80%;border:1px solid #CCC;margin-left:auto;margin-right:auto;margin-bottom:20px;">
                                        <tbody>
                                            <!-- current -->
                                            <g:each in="${providerGroupInstance.getContacts()}" var="i" status="row">
                                                <tr class="prop">
                                                    <td valign="top" class="name">
                                                        ${i?.contact?.buildName()}
                                                    </td>
                                                    ...
                                                    <td style="width:130px;">
                                                        <span class="bodyButton">
                                                            <g:link id="${i?.contact?.id}" class="removeAction" action="editInstitution" event="remove"
                                                                onclick="return confirm('Remove ${i?.contact?.buildName()} as a contact for this institution?');"
                                                            >
                                                                Remove
                                                            </g:link>
                                                        </span>
                                    ...
                                    <!--add existing-->
                                    <span style="margin-left:50px;">
                                        <g:message code="providerGroup.addAContact.label" default="Add a known contact to this institution" />
                                    </span>

                                    <table style="width:80%;border:1px solid #CCC;margin-left:auto;margin-right:auto;margin-bottom:20px;padding-left:20px;">
                                        <tr class="prop">
                                            <td valign="top" class="name">
                                                <g:message code="institution.edit.des03" />
                                            </td>
                                        ...
                                        <tr class="prop">
                                            <td valign="top" class="name">
                                                <label for="role">
                                                    <g:message code="institution.edit.des04" />
                                                    <br />
                                                    <span style="color:#777">
                                                        <g:message code="institution.edit.des05" />,
                                                        <br />
                                                        <g:message code="institution.edit.des06" />
                                                    </span>
                                                </label>
                                            </td>
                                        ...
                                        <tr class="prop">
                                            <td class="checkbox">
                                                <label for="isAdmin">
                                                    <g:message code="contactFor.administrator.label" default="Administrator" />
                                                </label>
                                            </td>
                                            ...
                                            <td class="checkbox">
                                                <label>
                                                    ...
                                                    <span class="hint">
                                                        <g:message code="institution.edit.des07" />
                                                    </span>
                                                </label>
                                            </td>
                                        </tr>
                                    ...
                                    <!-- add new -->
                                    <span style="margin-left:50px;">
                                        <g:message code="institution.edit.des08" />
                                    </span>
                                    ...
                                    <table style="width:80%;border:1px solid #CCC;margin-left:auto;margin-right:auto;margin-bottom:20px;padding-left:20px;">
                                        ...
                                        <tr class="prop">
                                            <td class="checkbox">
                                                <label for="publish">
                                                    <g:message code="contact.publish.label" default="Make public?" />
                                                </label>
                                            </td>
                                            ...
                                            <td class="checkbox">
                                                <label>
                                                    ...
                                                    <span class="hint">
                                                        <g:message code="institution.edit.des09" />
                                                    </span>
                                                </label>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="prop">
                                            <td valign="top" class="name">
                                                <label for="role">
                                                    <g:message code="contactFor.role.label" default="Role" />
                                                    <br />
                                                    <span style="color:#777;">
                                                        e.g. Manager,
                                                        <br />
                                        ...
                                        <tr class="prop">
                                            ...
                                            <td class="checkbox">
                                                <label>
                                                    ...
                                                    <span class="hint">
                                                        <g:message code="institution.edit.des10" />
                                                    </span>
                                                </label>
                                            </td>
                                        </tr>
