...
<html>
    ...
    <body>
        <div class="nav">
            ...
            <li><span class="menuButton"><g:link class="create" action="create" params="${[returnTo: returnTo]}"><g:message code="general.new.label" args="[entityName]" /></g:link></span></li>
        ...
        <div class="body">
            ...
            <div class="buttons">
                <g:form>
                    ...
                    <span class="button"><g:actionSubmit class="edit" action="edit" value="${message(code: 'general.button.edit.label', default: 'Edit')}" /></span>
                    <span class="button"><g:actionSubmit class="delete" action="delete" value="${message(code: 'general.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'general.button.delete.confirm.message', default: 'Are you sure?')}');" /></span>
                </g:form>
            </div>
        </div>
    </body>
