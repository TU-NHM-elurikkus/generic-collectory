                ...
                <div id="yourMetadata" class="infoSection hide">
                    ...
                    <g:else>
                        <cl:ifGranted role="ROLE_COLLECTION_ADMIN">
                            <p>
                                <strong><em><g:message code="manage.list.des05" />.</em></strong>
                            </p>
                        </cl:ifGranted>
                    ...
                    <div id="instructions">
                        <div id="requirementsForEditing">
                            ...
                            <cl:ifNotGranted role="ROLE_COLLECTION_EDITOR">
                                ...
                                <p>
                                    <g:message code="manage.list.des15" /> <span class="link" onclick="return sendEmail('support(SPAM_MAIL@ALA.ORG.AU)ala.org.au')"><g:message code="manage.list.des16" /></span>
