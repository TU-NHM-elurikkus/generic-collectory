    ...
    <body>
        <div class="nav">
            <g:if test="${mode == 'create'}">
                <h1>
                    <g:message code="collection.range.title01" />
                </h1>
            </g:if>
            <g:else>
                <h1>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td colspan="3">
                                    <h3>
                                        <g:message code="collection.range.title" />
                                    </h3>
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="geographicDescription">
                                        <g:message code="collection.range.label01" />
                                    </label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="states">
                                        <g:message code="collection.range.label02" />
                                    </label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="eastCoordinate">
                                        <g:message code="collection.range.label04" />
                                    </label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="westCoordinate">
                                        <g:message code="collection.range.label05" />
                                    </label>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="northCoordinate">
                                        <g:message code="collection.range.label06" />
                                    </label>
                                </td>
                            ...
                            <tr>
                                <td colspan="3">
                                    <h3>
                                        <g:message code="collection.range.title02" />
                                    </h3>
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="checkbox">
                                    <label for="kingdomCoverage">
                                        <g:message code="collection.range.label08" />
                                    </label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="scientificNames">
                                        <g:message code="collection.range.label09" />
                                    </label>
                                </td>
                            ...
                            <tr>
                                <td colspan="3">
                                    <h3>
                                        <g:message code="collection.range.title03" />
                                    </h3>
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="numRecords">
                                        <g:message code="collection.numRecords.label" />
                                    </label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="numRecordsDigitised">
                                        <g:message code="collection.numRecordsDigitised.label" />
                                    </label>
                                </td>
