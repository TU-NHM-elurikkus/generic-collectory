    ...
    <body id="body-wrapper">
        <div class="nav">
            <g:if test="${mode == 'create'}">
                <h1>
                    <g:message code="collection.des.title" />
                </h1>
            </g:if>
            <g:else>
                <h1>
        ...
        <div id="baseForm" >
            ...
            <g:form method="post" name="baseForm" action="base">
                ...
                <table class="span12">
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name span2">
                                <label for="pubDescription">
                                    <g:message code="providerGroup.pubDescription.label" />
                                </label>
                            </td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">
                                <label for="techDescription">
                                    <g:message code="providerGroup.techDescription.label" />
                                </label>
                            </td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">
                                <label for="collectionType">
                                    <g:message code="collection.collectionType.label" />
                                </label>
                            </td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">
                                <label for="active">
                                    <g:message code="providerGroup.sources.active.label" />
                                </label>
                            </td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">
                                <label for="startDate">
                                    <g:message code="collection.des.startdate" />
                                </label>
                            </td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">
                                <label for="endDate">
                                    <g:message code="collection.des.enddate" />
                                </label>
                            </td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">
                                <label for="keywords">
                                    <g:message code="collection.keywords.label" />
                                </label>
                            </td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">
                                <label for="subCollections">
                                    <g:message code="scope.subCollections.label" />
                                </label>
                            </td>
                            <td valign="top" class="value ${hasErrors(bean: command, field: 'scope.subCollections', 'errors')}">
                                <p>
                                    <g:message code="collection.des.des01" />.
                                </p>
                                <table class="shy">
                                    <colgroup>
                                        <col width="50%" />
                                    ...
                                    <tr>
                                        <td>
                                            <g:message code="collection.des.de02" />
                                        </td>
                                        <td>
                                            <g:message code="collection.des.des03" />
                                        </td>
                                    </tr>
                ...
                <div class="buttons">
                    <span class="button">
                        <input type="submit" class="btn" name="_action_updateDescription" value="${message(code:"collection.button.update")}" class="save" />
                    </span>
                    <span class="button">
                        <input type="submit"  class="btn"name="_action_cancel" value="${message(code:"collection.button.cancel")}" class="cancel" />
                    </span>
                </div>
            </g:form>
        </div>
