...
<html>
	<head>
		...
		<title><g:message code="general.create.label" args="[entityName]" /></title>
	</head>
	<body>
		<a href="#create-providerCode" class="skip" tabindex="-1"><g:message code="general.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-providerCode" class="content scaffold-create" role="main">
			<h1><g:message code="general.create.label" args="[entityName]" /></h1>
			...
			<g:form action="save" >
				...
				<fieldset class="buttons">
					<g:submitButton name="create" class="save" value="${message(code: 'general.button.create.label', default: 'Create')}" />
				</fieldset>
			</g:form>
		</div>
	</body>
