                ...
                <div class="dialog emulate-public">
                    ...
                    <div class="show-section well titleBlock">
                        ...
                        <g:if test="${instance.notes}">
                            <p>
                                <cl:formattedText>${fieldValue(bean: instance, field: "notes")}</cl:formattedText>
                            </p>
                        </g:if>
                    ...
                    <div class="show-section well">
                        <g:if test="${instance.gbifDataset}">
                            <cl:ifGranted role="${ProviderGroup.ROLE_ADMIN}">
                                <div class="float-right">
                                    <span class="buttons">
                                        <g:link class="edit btn" controller="manage" action="gbifDatasetDownload" id="${instance.uid}">
                        ...
                        <cl:ifGranted role="${ProviderGroup.ROLE_ADMIN}">
                            <div>
                                <span class="buttons">
                                    <p>
                                        <g:link class="edit btn" action='edit' params="[page:'contribution']" id="${instance.uid}">
                    ...
                    <div class="well">
                        ...
                        <p>
                            <g:link controller="dataResource" action="upload" class="btn" id="${instance.uid}">
                    ...
                    <div class="show-section well">
                        ...
                        <g:if test="${instance.permissionsDocumentType == 'Data Provider Agreement'}">
                            <p>
                                ...
                                <cl:tickOrCross test="${instance.riskAssessment}">yes|no</cl:tickOrCross>
                            </p>
                            ...
                            <p>
                                ...
                                <cl:tickOrCross test="${instance.filed}">yes|no</cl:tickOrCross>
                            </p>
                        </g:if>
