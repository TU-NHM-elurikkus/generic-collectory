...
<html>
    ...
    <body>
        ...
        <div class="nav">
            <h1>
                <g:message code="shared.location.main.title01" />: ${fieldValue(bean: command, field: "name")}
            </h1>
        </div>
        ...
        <div class="body">
            ...
            <g:form method="post" enctype="multipart/form-data" action="editCollection">
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="state">
                                        <g:message code="providerGroup.state.label" default="State/Territory/County" />
                                        <br />
                                        <span class=hint>
                                            (where the ${entityNameLower}<br>resides)
                                        </span>
                                    </label>
                                </td>
                            ...
                            <tr class='prop'>
                                <td valign="top" class="name">
                                    <label for="address.postBox">
                                        <g:message code="providerGroup.address.postBox.label" default="Postal address" />
                                    </label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="latitude">
                                        <g:message code="providerGroup.latitude.label" default="Latitude" />
                                        <br />
                                        <span class=hint>
                                            (decimal degrees)
                                        </span>
                            ...
                            <tr>
                                <td></td>
                                <td colspan="2">
                                    <input type="button" class="classicButton btn" onclick="return codeAddress();" value="Lookup" />
                                    <g:message code="shared.location.lookup" />.
                            ...
                            <g:if test="${command.ENTITY_TYPE == 'Collection'}">
                                <g:if test="${(command.latitude == -1 || command.longitude == -1) && command.inheritedLatLng()}">
                                    <tr>
                                        <td></td>
                                        <td colspan="2">
                                            <input type="button" class="classicButton" onclick="return useInherited();" value="Use inherited" />
                                            <g:message code="shared.location.button.useinherited" />.
                                            <div style="width:100%;"></div>
                                        </td>
                                    </tr>
                                </g:if>
                            ...
                            <tr>
                                <td></td>
                                <td colspan="2">
                                    <g:message code="shared.location.main.des01" /> ${entityNameLower}.
                                    <br />
                ...
                <div class="buttons">
                    <span class="button">
                        <input type="submit" name="_action_updateLocation" value="${message(code:"shared.location.button.update")}" class="save btn" />
                    </span>
                    <span class="button">
                        <input type="submit" name="_action_cancel" value="${message(code:"shared.location.button.cancel")}" class="cancel btn" />
                    </span>
                </div>
            </g:form>
        </div>
