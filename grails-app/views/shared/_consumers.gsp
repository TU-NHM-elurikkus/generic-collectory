...
<div class="show-section well">
    ...
    <p>
        <span class="buttons long">
            <g:link class="edit btn" action='editConsumers' params="[source:'co']" id="${instance.uid}">
                <g:message code="shared.consumers.link01" />&nbsp;
            </g:link>
        </span>

        <span class="buttons long">
            <g:link class="edit btn" action='editConsumers' params="[source:'in']" id="${instance.uid}">
