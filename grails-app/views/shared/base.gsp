        ...
        <div class="card">
            ...
            <div id="baseForm" class="body card-block">
                ...
                <g:form method="post" name="baseForm" action="base">
                    ...
                    <div class="buttons">
                        <button type="submit" name="_action_updateBase" class="erk-button erk-button--light">Update</button>
                        <button type="submit" name="_action_cancel" value="Cancel" class="erk-button erk-button--light">Cancel</button>
                    </div>
                </g:form>
            </div>
        </div>
