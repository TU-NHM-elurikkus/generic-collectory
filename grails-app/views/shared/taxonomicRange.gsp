    ...
    <section>
        <div class="row">
            <div class="col-sm-6">
                ...
                <ul>
                    <li><a href="#"><g:message code="shared.tr.help.link01" />?</a></li>
                    <li><a href="#"><g:message code="shared.tr.help.link02" />?</a></li>
                    <li><a href="#"><g:message code="shared.tr.help.link03" />?</a></li>
                    <li><a href="#"><g:message code="shared.tr.help.link04" />?</a></li>
                </ul>
            </div>
            ...
            <div class="col-sm-6">
                ...
                <ul>
                    <li><a href="#"><g:message code="shared.tr.help.link05" />?</a></li>
                    <li><a href="#"><g:message code="shared.tr.help.link06" />?</a></li>
                    <li><a href="#"><g:message code="shared.tr.help.link07" />?</a></li>
                    <li><a href="#"><g:message code="shared.tr.help.link08" />?</a></li>
                </ul>
            </div>
        </div>
    </section>
