...
<html>
    <head>
        ...
        <title><g:message code="profile.base.label" /></title>
    </head>

    <body>
        <div class="nav">
            <h1 style="display:inline;">
                <g:message code="contact.sp.title01" /> (${contact.email})
            </h1>

            <span style="float:right;" class="menuButton">
                <cl:homeLink />
            </span>
        </div>
            ...
            <g:form method="post" action="updateProfile">
                ...
                <div class="dialog custom-edit">
                    <h2 style="padding-top:10px;">
                        <g:message code="contact.sp.title02" />
                    </h2>
                            ...
                            <tbody>
                                ...
                                <tr class="prop">
                                    <td>
                                        <table class="shy">
                                            <tr>
                                                <td style="vertical-align:middle;color:gray;">
                                                    <g:message code="contact.sp.title03" />:
                                                </td>
                                                ...
                                                <td style="vertical-align:middle;color:gray;">
                                                    <g:message code="contact.sp.title04" />:
                                                </td>
                                                ...
                                                <td style="vertical-align:middle;color:gray;">
                                                    <g:message code="contact.sp.title05" />:
                                                </td>
                    ...
                    <div class="repeats">
                        <g:each var="cr" in="${contactRels}">
                            ...
                            <h2>
                                <g:message code="contact.sp.title06" /> ${cr.entityName} (${uid})
                            </h2>
                ...
                <div class="buttons">
                    <span class="button">
                        <input type="submit" name="_action_updateProfile" value="${message(code:"collection.button.update")}" class="save btn">
                    </span>

                    <span class="button">
                        <input type="submit" name="_action_cancelProfile" value="${message(code:"collection.button.cancel")}" class="cancel btn">
                    </span>
                </div>
            </g:form>
        </div>
