<g:form action="save" method="post" >
    ...
    <div class="buttons">
        <g:if test="${!providerMapInstance.dateCreated}">
            <span class="button"><g:submitButton name="create" class="save btn" value="${message(code: 'general.button.create.label', default: 'Create')}" /></span>
        </g:if>
        <g:else>
        <div class="buttons">
            <span class="button"><g:actionSubmit class="save btn" action="update" value="${message(code: 'general.button.update.label', default: 'Update')}" /></span>
            <span class="button"><g:actionSubmit class="delete btn" action="delete" value="${message(code: 'general.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'general.button.delete.confirm.message', default: 'Are you sure?')}');" /></span>
        </div>
        </g:else>
