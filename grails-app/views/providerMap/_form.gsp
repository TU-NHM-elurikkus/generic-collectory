<g:form action="save" method="post" >
    ...
    <div class="dialog">
        <table>
            <tbody>
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="institution">
                            <g:message code="providerMap.institution.label" default="Institution" />
                        </label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="collection">
                            <g:message code="providerMap.collection.label" default="Collection" />
                        </label>
                    </td>
                    <td valign="top" class="value ${hasErrors(bean: providerMapInstance, field: 'providerGroup', 'errors')}">
                        <g:select
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="institutionCodes">
                            <g:message code="providerMap.institutionCodes.label" default="Institution codes" />
                        </label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="collectionCodes">
                            <g:message code="providerMap.collectionCodes.label" default="Collection codes" />
                        </label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="warning">
                            <g:message code="providerMap.warning.label" default="Warning" />
                        </label>
                    </td>
    ...
    <div class="buttons">
        <g:if test="${!providerMapInstance.dateCreated}">
            <span class="button">
                <g:submitButton name="create" class="save btn" value="${message(code: 'general.button.create.label', default: 'Create')}" />
            </span>
        </g:if>
        <g:else>
            <div class="buttons">
                <span class="button">
                    <g:actionSubmit class="save btn" action="update" value="${message(code: 'general.button.update.label', default: 'Update')}" />
                </span>
                <span class="button">
                    <g:actionSubmit
                        class="delete btn"
