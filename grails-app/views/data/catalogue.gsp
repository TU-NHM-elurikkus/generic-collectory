        ...
        <div class="section infoPage">
          ...
          <table class="table">
            ...
            <tr>
              ...
              <td><a href="${Holders.config.grails.serverURL}/ws">http://collections.ala.org.au/ws</a></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.table01.cell0201" />:</td>
              <td><a href="${Holders.config.grails.serverURL}/ws/institution.json">http://collections.ala.org.au/ws/institution</a></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.table01.cell0301" />:</td>
              <td><a href="${Holders.config.grails.serverURL}/ws/institution/in72.json">http://collections.ala.org.au/ws/institution/in72</a></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.table01.cell0401" />:</td>
              <td><a href="${Holders.config.grails.serverURL}/ws/institution/count">http://collections.ala.org.au/ws/institution/count</a></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.table01.cell0501" />:</td>
              <td><a href="${Holders.config.grails.serverURL}/ws/institution/count/state">http://collections.ala.org.au/ws/institution/count/state</a></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.table01.cell0601" />:</td>
              <td><a href="${Holders.config.grails.serverURL}/ws/institution/in72/contacts.json">http://collections.ala.org.au/ws/institution/in72/contacts</a></td>
            </tr>
          </table>
