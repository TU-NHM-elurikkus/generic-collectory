		...
		<div id="show-licence" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="btn edit" action="edit" id="${licenceInstance?.id}"><g:message code="general.button.edit.label" default="Edit" /></g:link>
					<g:actionSubmit class="delete btn" action="delete" value="${message(code: 'general.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'general.button.delete.confirm.message', default: 'Are you sure?')}');" />
				</fieldset>
			</g:form>
		</div>
	</body>
