...
<head>
    ...
    <r:script>
        ...
        bieServiceUrl = "${grailsApplication.config.bie.serviceURL}";
...
<div class="row-fluid">
    ...
    <div class="span4">
        ...
        <div id="dataAccessWrapper" style="display:none;">
            <g:render template="dataAccess" model="[instance:instance]" plugin="collectory"/>
        </div>
    ...
    <!-- contacts -->
        ...
        <g:render template="contacts" bean="${contacts}" plugin="collectory"/>
...
<script type="text/javascript">
    ...
    // configure the charts
      ...
      var taxonomyTreeOptions = {
          ...
          /* base url of the biocache webapp*/
          biocacheWebappUrl: CHARTS_CONFIG.biocacheWebappUrl,
          /* base url of BIE webapp*/
          bieWebappUrl: CHARTS_CONFIG.bieUrl,
          ...
          success: function(data) {
              ...
              if (pages) {
                  ...
                  $contrib.append($('<h2>Contribution to the Atlas</h2><p>This resource has contributed to <strong>' +
                      ...
                      '<a href="' + bieServiceUrl + '/search?q=*&fq=uid:' + "${instance.uid}" + '">View a list</a></p>'));
              }
          }
      });
      */
