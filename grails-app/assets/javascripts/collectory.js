...
function setNumbers(totalBiocacheRecords) {
    ...
    switch(totalBiocacheRecords) {
        case 0: recordsClause = $.i18n.prop('public.show.portalRecordsBit.noRecords'); break;
        case 1: recordsClause = $.i18n.prop('public.show.portalRecordsBit.oneRecord'); break;
        default: recordsClause = $.i18n.prop('public.show.portalRecordsBit.records', totalBiocacheRecords.toLocaleString(GLOBAL_LOCALE_CONF.locale));
    }
...
function loadDownloadStats(loggerServicesUrl, uid, name, eventType) {
    ...
    var displayNameMap = {
        'thisMonth': $.i18n.prop('collectory.js.thismonth'),
        'last3Months': $.i18n.prop('collectory.js.last3month'),
        'lastYear': $.i18n.prop('collectory.js.last12month'),
        'all': $.i18n.prop('collectory.js.alldownloads')
    };
            ...
            $.each(displayNameMap, function(nameKey, displayString) {
                ...
                $.each(reasons, function(index, details) {
                    ...
                    usageTableRow +=
                        ...
                        $.i18n.prop('collectory.js.stats.events', details.value.events.toLocaleString(GLOBAL_LOCALE_CONF.locale)) +
                        '</td><td style="text-align: right">' +
                        $.i18n.prop('collectory.js.stats.records', details.value.records.toLocaleString(GLOBAL_LOCALE_CONF.locale)) +
                        '</td></tr>';
